      ...
      {lightboxMedia && (
        ...
        >
          <button
            ...
            className="absolute top-4 left-4 text-white z-10 flex items-center gap-1.5 bg-black/40 backdrop-blur-sm px-3 py-2 rounded-full hover:bg-black/60 transition-colors"
          >
